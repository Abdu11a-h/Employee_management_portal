<?php include('admin_dashboard_header.php'); ?>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <div class="btn-group">
                                                                        ...
                                                                        <div class="dropdown-menu">
                                                                            <a class="dropdown-item approve-leave" href="#" data-id="<?php echo encode($data->id) ?>">Approve</a>
                                                                            <a class="dropdown-item reject-leave" href="#" data-id="<?php echo encode($data->id) ?>">Reject</a>
    ...
    $(document).ready(function() {
        $('.approve-leave').click(function(event) {
            console.log('hitting');
            ...
            $.ajax({
                url: "<?php echo USER_REGISTRATION_API.'approve_leave_request_admin/' ?>",
                type: "POST",
                data: {id: leaveId},
                success: function(response) {
                   
                    console.log("success");
                    window.location.href = "<?php echo base_url('UserRegistrationBasic/admin_leaverequests'); ?>";
        ...
        $('.reject-leave').click(function(event) {
            console.log('hitting');
            event.preventDefault(); 
            ...
            $.ajax({
                url: "<?php echo USER_REGISTRATION_API.'reject_leave_request_admin/' ?>",
                type: "POST",
                data: {id: leaveId},
                success: function(response) {
