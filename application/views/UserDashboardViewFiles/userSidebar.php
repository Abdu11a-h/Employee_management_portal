  ...
  <div id="sidebarmini" class="sidebar border shadow relative" style="cursor:pointer;">
    ...
    <div>
      ...
      <p>
        <a href="<?php echo USER_REGISTRATION_BASIC . 'userDasboard'; ?>" style="color:white;"> <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-dashboard mr-2 mb-1" width="24" height="24" viewBox="0 0 24 24" stroke-width="1.5" stroke="white" fill="none" stroke-linecap="round" stroke-linejoin="round">
            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
      ...
      <a href="<?php echo USER_REGISTRATION_BASIC . 'profileSettings'; ?>" style="color:white;">
        <p class="text-white">
          <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-user mr-2 mb-1" width="24" height="24" viewBox="0 0 24 24" stroke-width="1.5" stroke="white" fill="none" stroke-linecap="round" stroke-linejoin="round">
            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
      ...
      <a href="<?php echo USER_REGISTRATION_BASIC . 'apply_leave'; ?>" style="color:white;">
        <p class="text-white">
          <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-user mr-2 mb-1" width="24" height="24" viewBox="0 0 24 24" stroke-width="1.5" stroke="white" fill="none" stroke-linecap="round" stroke-linejoin="round">
            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
            <circle cx="12" cy="7" r="4" />
      ...
      <a href="<?php echo USER_REGISTRATION_BASIC . 'leave_requests'; ?>" style="color:white;">
        <p class="text-white">
          <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-user mr-2 mb-1" width="24" height="24" viewBox="0 0 24 24" stroke-width="1.5" stroke="white" fill="none" stroke-linecap="round" stroke-linejoin="round">
            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
            <circle cx="12" cy="7" r="4" />
      ...
      <a href="<?php echo USER_REGISTRATION_BASIC . 'logout'; ?>" style="color:white;">
        <p class="dash-side">
          <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-logout" width="24" height="24" viewBox="0 0 24 24" stroke-width="1.5" stroke="white" fill="none" stroke-linecap="round" stroke-linejoin="round">
            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
