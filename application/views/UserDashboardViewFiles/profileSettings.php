                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="form-group right-dir">
                          ...
                          <input type="email" class="form-control ltr" name="salary" id="salary" placeholder="" value="<?php echo isset($profile_details->salary) ? $profile_details->salary : ''; ?> " readonly>
                      ...
                      <div class="flex justify-center col-12 mt-2">
                        <div class="col-md-2 brand-btn py-2 form-group" style="cursor: pointer;">
                          <div onClick="submitForm_to('<?php echo USER_REGISTRATION_API . 'updateUser' ?>','<?php echo USER_REGISTRATION_BASIC . 'profileSettings' ?>','updateForm')">
                      ...
                      <span class="p-4"> Already a Member?<span><a href="<?php echo USER_REGISTRATION_BASIC . 'login'; ?>" style="font-weight:bold;"> Login</a></span></span>
                    </div> -->
                  </form>
                </div>
              </div>
