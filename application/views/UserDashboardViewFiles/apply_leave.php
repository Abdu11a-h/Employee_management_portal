            ...
            <div class="row no-gutters">
              ...
              <div class="col-md-12" id="signupScroll">
                <div class="contact-wrap w-100 p-md-5 p-4 shadow p-3 mb-5 bg-body rounded">
                  ...
                  <form method="" action="" enctype="multipart/form-data" id="leaveForm" class="contactForm">
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group right-dir">
                         ...
                         First Name
                          ...
                          <input type="text" class="form-control ltr" name="firstname" id="firstname" placeholder="" value="<?php echo isset($profile_details->firstname) ? $profile_details->firstname : ''; ?>" readonly>
                      ...
                      <div class="col-md-6">
                        ...
                        Last Name
                          ...
                          <input type="text" class="form-control ltr" name="lastname" id="lastname" placeholder="" value="<?php echo isset($profile_details->lastname) ? $profile_details->lastname : ''; ?>"readonly>
                      ...
                      <div class="col-md-6">
                        <div class="form-group right-dir">
                          <label class="label noto-font" for="reason"><i class="fa fa-user"></i>
                        Reason
                        </label>
                          <input type="text" class="form-control ltr" name="reason" id="reason" placeholder="Enter Reason" value="" required>
                          <span style="display:none;padding: 0px; margin-bottom: 10px; text-shadow: none;" class="reason_info"></span>
                        </div>
                      </div>
                    
                      <div class="col-md-6">
                        <div class="form-group right-dir">
                            <label class="label noto-font" for="leaveFrom"><i class="fa fa-user"></i> Leave From</label>
                            <input type="date" class="form-control ltr" name="leaveFrom" id="leaveFrom" placeholder="" value="<?php echo isset($profile_details->leaveFrom) ? $profile_details->leaveFrom : ''; ?>">
                            <span style="display:none;padding: 0px; margin-bottom: 10px; text-shadow: none;" class="leaveFrom_info"></span>
                        </div>
                    </div>

                    <div class="col-md-6">
                        <div class="form-group right-dir">
                            <label class="label noto-font" for="leaveTill"><i class="fa fa-user"></i> Leave Till</label>
                            <input type="date" class="form-control ltr" name="leaveTill" id="leaveTill" placeholder="" value="<?php echo isset($profile_details->leaveTill) ? $profile_details->leaveTill : ''; ?>">
                            <span style="display:none;padding: 0px; margin-bottom: 10px; text-shadow: none;" class="leaveTill_info"></span>
                        </div>
                    </div>
                    ...
                    <input type="hidden" class="form-control ltr" name="reference_code" id="reference_code" placeholder="" value="<?php echo isset($profile_details->reference_code) ? $profile_details->reference_code : ''; ?>">
                      ...
                      <div class="flex justify-center col-12 mt-2">
                        <div class="col-md-2 brand-btn py-2 form-group" style="cursor: pointer;">
                          <div onClick="submitForm_to('<?php echo USER_REGISTRATION_API . 'apply_leave' ?>','<?php echo USER_REGISTRATION_BASIC . 'leave_requests' ?>','leaveForm')">
                      ...
                      <div class="col-lg-12 text-center py-4">
                        <center>
                          <div style="padding: 0px; line-height: 20px; text-shadow: none;" id="msgs-leaveForm"></div>
                        </center>
                      </div>
